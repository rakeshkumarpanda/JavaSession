...
class Child0504202205 extends Parent0504202205
{
	public void pM1()
	{
...
public class ClassInheritance5 {
	...
	{
		Parent0504202205 p = new Child0504202205();// Upcasting: Storing the child class object in to parent class reference
		p.pM1();
		p.pM2();
		p.pM3();
...
//		Child0504202205 c = new Parent0504202205();//CE becuase of downcasting and downcasting is explicit
		Child0504202205 c = (Child0504202205)new Parent0504202205();//Not recommended
		c.cM3();
		c.pM1();
		c.pM2();
		c.pM3();
